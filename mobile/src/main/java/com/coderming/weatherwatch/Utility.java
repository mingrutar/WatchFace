...
public class Utility {
    ...
    // sync watch
    public static void notifyWatchWeatherChanged(Context context, TodayWeatherBrief briefWeather) {
        WearableProxy.getInstance().updateWeatherData(briefWeather.getHigh(),
                briefWeather.getLow(), briefWeather.getWeatherId(), briefWeather.getDesc());
    }
    public static void notifyWatciUnitChanged(Context context) {
        WearableProxy.getInstance().updateUnitSelection(isMetric(context));
    }
